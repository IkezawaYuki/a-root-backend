...
func NewWordpressPost(instaDetail external.InstagramPost, wpMedia []*external.UploadMediaResponse) WordpressPost {
...
func getCarousel(instaDetail external.InstagramPost, wpMedia []*external.UploadMediaResponse) string {
	sb := strings.Builder{}
